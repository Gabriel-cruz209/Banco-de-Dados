...
status_curso varchar(6) default 'Ativo' not null
);
...
insert into INSCRIÇÕES (data_inscricao) 
values
('1995-04-12'),
('1988-09-23'),
('2000-01-30'),
...
('Logistica','Controle e Planejamento', 2000, 'Inativ');

insert into AVALIAÇÕES (comentario_avaliacao, nota_avaliacao)
values
('Melhore',1),
('Bom Trabalho',9),
('Adequado',8);
...
delete from CURSOS where status_curso = 'Inativ';
